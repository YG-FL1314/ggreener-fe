...
function searchCompanies(start, limit) {
    ...
    if (!isEmpty(members)) tags.concat(members)
    if (!isEmpty(attentions)) tags.concat(attentions)
    if (!isEmpty(regions)) tags.concat(regions)    
    if (!isEmpty(zols)) tags.concat(zols) 
    ...
    if (!isEmpty(companyMarkets)) tags.concat(companyMarkets) 
